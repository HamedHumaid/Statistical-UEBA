...
features_df["after_hours_ratio"] = (
    features_df["after_hours_logins"] /
    features_df["login_count"].replace(0, 1)
)

features_df["files_per_login"] = (
    features_df["files_accessed"] /
    features_df["login_count"].replace(0, 1)
)

features_df["emails_per_login"] = (
    features_df["email_count"] /
    features_df["login_count"].replace(0, 1)
)
